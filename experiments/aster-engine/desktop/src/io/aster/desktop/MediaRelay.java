    ...
    private void serve(HttpExchange exchange){
        ...
        try{
            ...
            for(int redirects=0;;redirects++){
                ...
                c.setConnectTimeout(8000);c.setReadTimeout(8000);c.setInstanceFollowRedirects(false);c.setRequestProperty("Accept-Encoding","identity");c.setRequestProperty("User-Agent","AsterEnginePreview/0.8");
