...
/** Direct credential-free downloads for native Android Save As. */
public final class FileTransfer {
    ...
    public static void save(URI initial,OutputStream output,Progress progress)throws IOException {
        ...
        for(int redirect=0;redirect<=5;redirect++){
            ...
            c.setRequestProperty("User-Agent","Aster/0.2");c.setRequestProperty("Accept-Encoding","identity");
            try{int code=c.getResponseCode();if(code==301||code==302||code==303||code==307||code==308){
